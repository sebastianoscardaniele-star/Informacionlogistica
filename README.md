...
- Selección por tienda: BNA, Macro, Comafi, Ciudad y MasBanco.
...
- Exportación de datos editados en formato XLSX, con una solapa por tienda.
...
Los datos iniciales vienen de los archivos Excel originales y quedan embebidos en `src/data.js`. Los cambios que haga cada usuario se guardan localmente en su navegador mediante `localStorage`. El botón **Exportar XLSX** descarga un Excel con todas las tiendas en solapas separadas.
